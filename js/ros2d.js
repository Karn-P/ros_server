...
const createjs = require('createjs-module');// convert the given global Stage coordinates to ROS coordinates
// require('/home/kamuspace/karn/ROS/ros-server/node_modules/createjs-module/createjs.js')

const EventEmitter2 = require("../js/eventemitter2.min");
...
ROS2D.Viewer = function (options) {
  ...
  // this.scene =  createjs.Stage(canvas);
